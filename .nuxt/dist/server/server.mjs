...
const __vite_ssr_import_8__ = await __vite_ssr_import__("/assets/images/mycollection/html-5.svg");

const __vite_ssr_import_9__ = await __vite_ssr_import__("/assets/images/mycollection/css3.svg");

const __vite_ssr_import_10__ = await __vite_ssr_import__("/assets/images/mycollection/tailwindcss.svg");

const __vite_ssr_import_11__ = await __vite_ssr_import__("/assets/images/mycollection/javascript.svg");

const __vite_ssr_import_12__ = await __vite_ssr_import__("/assets/images/mycollection/vue.svg");

const __vite_ssr_import_13__ = await __vite_ssr_import__("/assets/images/mycollection/nuxt.svg");

const __vite_ssr_import_14__ = await __vite_ssr_import__("/assets/images/mycollection/expressjs-icon.svg");

const __vite_ssr_import_15__ = await __vite_ssr_import__("/assets/images/mycollection/mongodb-icon.svg");

const __vite_ssr_import_16__ = await __vite_ssr_import__("/assets/images/mycollection/mariadb-icon.svg");

const __vite_ssr_import_17__ = await __vite_ssr_import__("/assets/images/mycollection/wordpress-icon.svg");

const __vite_ssr_import_18__ = await __vite_ssr_import__("/assets/images/mycollection/canva-icon.svg");

const __vite_ssr_import_19__ = await __vite_ssr_import__("/assets/images/mycollection/vscode.svg");

const __vite_ssr_import_20__ = await __vite_ssr_import__("/assets/images/mycollection/git.svg");

const __vite_ssr_import_21__ = await __vite_ssr_import__("/assets/images/mycollection/digitalocean-icon.svg");
...
const __vite_ssr_import_22__ = await __vite_ssr_import__("/components/skills.vue?vue&type=style&index=0&lang.css");
...
__vite_ssr_exports__.default = /*#__PURE__*/__vite_ssr_import_24__.default(_sfc_main, [['ssrRender',_sfc_ssrRender],['__file',"C:/Users/acer/Desktop/ganpatjangra.me/components/skills.vue"]]);
}
...
const __vite_ssr_import_10__ = await __vite_ssr_import__("/assets/images/team/placeholder-photo.png");

const __vite_ssr_import_11__ = await __vite_ssr_import__("/assets/images/mycollection/html-5.svg");

const __vite_ssr_import_12__ = await __vite_ssr_import__("/assets/images/mycollection/tailwindcss.svg");

const __vite_ssr_import_13__ = await __vite_ssr_import__("/assets/images/mycollection/javascript.svg");

const __vite_ssr_import_14__ = await __vite_ssr_import__("/assets/images/mycollection/vue.svg");

const __vite_ssr_import_15__ = await __vite_ssr_import__("/assets/images/mycollection/nuxt.svg");

const __vite_ssr_import_16__ = await __vite_ssr_import__("/assets/images/team/photo4.png");
          ...
          default: __vite_ssr_import_8__.withCtx((_, _push, _parent, _scopeId) => {
            if (_push) {
              _push(`<div class="w-full px-1 mb-4 xl:w-auto xl:mb-0"${
                ...
                _scopeId
              }>Project Technologies</h4><div class="flex justify-between"${
                _scopeId
              }><div class="mx-auto"${
                _scopeId
              }><img class="w-20 h-20 mx-auto mb-5"${
...
const __vite_ssr_import_0__ = await __vite_ssr_import__("/assets/css/style.css");
...
const __vite_ssr_import_2__ = await __vite_ssr_import__("/assets/images/mycollection/lines-blue1.svg");

const __vite_ssr_import_3__ = await __vite_ssr_import__("/assets/images/mycollection/lines-blue2.svg");

const __vite_ssr_import_4__ = await __vite_ssr_import__("/assets/images/mycollection/Diploma.svg");

const __vite_ssr_import_5__ = await __vite_ssr_import__("/assets/images/mycollection/Light-Bulb.svg");

const __vite_ssr_import_6__ = await __vite_ssr_import__("/assets/images/mycollection/Plane.svg");

const __vite_ssr_import_7__ = await __vite_ssr_import__("/assets/images/mycollection/myAvatar.svg");

const __vite_ssr_import_8__ = await __vite_ssr_import__("/assets/images/mycollection/github-icon.svg");

const __vite_ssr_import_9__ = await __vite_ssr_import__("/assets/images/mycollection/linkedin-tile.svg");

const __vite_ssr_import_10__ = await __vite_ssr_import__("/assets/images/mycollection/gmail-icon.svg");

const __vite_ssr_import_11__ = await __vite_ssr_import__("/assets/images/mycollection/icon1.svg");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${
    ...
    __vite_ssr_import_1__.ssrRenderAttr("src", __vite_ssr_import_4__.default)
    ...
    __vite_ssr_import_1__.ssrRenderAttr("src", __vite_ssr_import_5__.default)
    ...
    __vite_ssr_import_1__.ssrRenderAttr("src", __vite_ssr_import_6__.default)
    ...
    __vite_ssr_import_1__.ssrRenderAttr("src", __vite_ssr_import_7__.default)
    ...
    __vite_ssr_import_1__.ssrRenderAttr("src", __vite_ssr_import_8__.default)
    ...
    __vite_ssr_import_1__.ssrRenderAttr("src", __vite_ssr_import_9__.default)
    ...
    __vite_ssr_import_1__.ssrRenderAttr("src", __vite_ssr_import_10__.default)
    ...
    __vite_ssr_import_1__.ssrRenderAttr("src", __vite_ssr_import_11__.default)
...
__vite_ssr_exports__.default = /*#__PURE__*/__vite_ssr_import_13__.default(_sfc_main, [['ssrRender',_sfc_ssrRender],['__file',"C:/Users/acer/Desktop/ganpatjangra.me/components/home.vue"]]);
}
...
// --------------------
const $id_2262f03b = async function (global, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
/* empty */;
}
