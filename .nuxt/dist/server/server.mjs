...
const __vite_ssr_import_3__ = await __vite_ssr_import__("/assets/images/mycollection/myAvatar.svg");

const __vite_ssr_import_4__ = await __vite_ssr_import__("/assets/images/mycollection/github-icon.svg");

const __vite_ssr_import_5__ = await __vite_ssr_import__("/assets/images/mycollection/linkedin-tile.svg");

const __vite_ssr_import_6__ = await __vite_ssr_import__("/assets/images/mycollection/gmail-icon.svg");

const __vite_ssr_import_7__ = await __vite_ssr_import__("/assets/images/mycollection/icon1.svg");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  } alt=""></span><!-- full stack --><span class="relative z-10"> web dev.</span></span></h1><div class="space-y-2"><h1 class="text-xl capitalize">previous study</h1><p class="text-lg leading-snug lg:mb-24 text-darkBlueGray-400">In 2020, I complete my engineering.</p><h1 class="text-xl capitalize">currently study</h1><p class="text-lg leading-snug lg:mb-24 text-darkBlueGray-400">leaning MEVN and communication skills in English language.</p><h1 class="text-xl capitalize">future study</h1><p class="text-lg leading-snug lg:mb-24 text-darkBlueGray-400">BCA in Australia.</p></div></div><div class="w-full px-4 lg:w-1/2"><div class="relative mx-auto"><div class="w-64 h-64 mx-auto border-4 border-gray-700 rounded-full"><!-- profile image second circule  --><div class="w-56 h-56 mx-auto border-4 border-gray-400 rounded-full"><!-- profile image third circule  --><div class="relative flex items-center justify-center w-48 h-48 mx-auto border-4 rounded-full"><img class="w-36 -mt-9"${
    __vite_ssr_import_0__.ssrRenderAttr("src", __vite_ssr_import_3__.default)
  } alt=""></div></div></div></div></div></div><div class="mb-5 mx-4 lg:mx-7"><h1 class="capitalize text-6xl font-semibold mb-5">Contact</h1><div class="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 place-items-center"><div class="flex items-center w-full mb-6 xl:w-1/2"><img class="mr-6 h-14"${
    __vite_ssr_import_0__.ssrRenderAttr("src", __vite_ssr_import_4__.default)
  } alt=""><a class="text-3xl font-medium hover:text-blueGray-500" target="blankpage" href="https://github.com/GanpatJangra">Github <h1 class="text-sm">@ganpatjangra</h1></a></div><div class="flex items-center w-full mb-6 xl:w-1/2"><img class="mr-6 h-14"${
    __vite_ssr_import_0__.ssrRenderAttr("src", __vite_ssr_import_5__.default)
  } alt=""><a class="text-3xl font-medium hover:text-blueGray-500" target="blankpage" href="https://www.linkedin.com/in/ganpat-jangra-4b3a9621a/">Linkdin <h1 class="text-sm">@ganpatjangra</h1></a></div><div class="flex items-center w-full mb-6 xl:w-1/2"><img class="mr-6 h-14"${
    __vite_ssr_import_0__.ssrRenderAttr("src", __vite_ssr_import_6__.default)
  } alt=""><a class="text-3xl font-medium hover:text-blueGray-500" target="blankpage" href="#">Mail <h1 class="text-sm">ganpatjangra@gmail.com</h1></a></div><div class="flex items-center w-full mb-6 xl:w-1/2"><img class="mr-6 h-14"${
...
__vite_ssr_exports__.default = /*#__PURE__*/__vite_ssr_import_9__.default(_sfc_main, [['ssrRender',_sfc_ssrRender],['__file',"C:/Users/acer/Desktop/ganpatjangra.me/components/home.vue"]]);
}
