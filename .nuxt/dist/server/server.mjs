...
import require$$0, { reactive, getCurrentInstance, ref, computed, defineComponent, resolveComponent, withCtx, createVNode, resolveDynamicComponent, openBlock, createBlock, useSSRContext, h, Transition, Suspense, createCommentVNode, shallowRef, defineAsyncComponent, mergeProps, createApp, createTextVNode, unref } from "vue";
import { ssrRenderComponent, ssrRenderVNode, ssrRenderSuspense, ssrRenderAttrs, ssrRenderAttr, ssrRenderClass } from "vue/server-renderer";
...
const components = {
  "Darkbutton": defineAsyncComponent(() => Promise.resolve().then(function() {
    return darkbutton;
  }).then((c) => c.default || c)),
                        ...
                        createVNode("div", { class: "flex flex-wrap items-start -mx-4" }, [
                          createVNode("div", { class: "w-full px-4 md:w-1/2 lg:w-1/4 mb-14 lg:mb-0" }, [
                            createVNode("div", { class: "relative h-full px-6 pt-16 pb-8 text-center bg-gray-100 shadow-sm shrink-0 rounded-7xl shadow-gray-300" }, [
                              ...
                              createVNode("span", { class: "p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50" }, "HTML 5")
                            ])
                          ]),
                          createVNode("div", { class: "w-full px-4 md:w-1/2 lg:w-1/4 mb-14 lg:mb-0 lg:mt-20" }, [
                            createVNode("div", { class: "relative h-full px-6 pt-16 pb-8 text-center bg-gray-100 shadow-sm rounded-7xl shadow-gray-300" }, [
                              ...
                              createVNode("span", { class: "p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50" }, [
                                createTextVNode("CSS 3 "),
                                createVNode("span", { class: "text-[#38BDF8]" }, "||"),
                          ...
                          createVNode("div", { class: "w-full px-4 md:w-1/2 lg:w-1/4 mb-14 lg:mt-20" }, [
                            createVNode("div", { class: "relative h-full px-6 pt-16 pb-8 text-center bg-gray-100 shadow-sm rounded-7xl shadow-gray-300" }, [
                              ...
                              createVNode("span", { class: "p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50" }, "Java script")
                            ])
                          ]),
                          createVNode("div", { class: "w-full px-4 pb-4 md:w-1/2 lg:w-1/4" }, [
                            createVNode("div", { class: "relative h-full px-6 pt-16 pb-8 text-center bg-gray-100 shadow-sm rounded-7xl shadow-gray-300" }, [
                              ...
                              createVNode("span", { class: "p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50" }, [
                                ...
                                createVNode("span", { class: "text-[#00DC82]" }, "||"),
                        ...
                        createVNode("div", { class: "flex flex-wrap items-start -mx-4" }, [
                          createVNode("div", { class: "w-full px-4 md:w-1/2 lg:w-1/4 mb-14 lg:mb-0" }, [
                            createVNode("div", { class: "relative h-full px-6 pt-16 pb-8 text-center bg-gray-100 shadow-sm shrink-0 rounded-7xl shadow-gray-300" }, [
                              ...
                              createVNode("span", { class: "p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50" }, "express js")
                            ])
                          ]),
                          createVNode("div", { class: "w-full px-4 md:w-1/2 lg:w-1/4 mb-14 lg:mb-0 lg:mt-20" }, [
                            createVNode("div", { class: "relative h-full px-6 pt-16 pb-8 text-center bg-gray-100 shadow-sm rounded-7xl shadow-gray-300" }, [
                              ...
                              createVNode("span", { class: "p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50" }, "mongo db")
                            ])
                          ]),
                          createVNode("div", { class: "w-full px-4 md:w-1/2 lg:w-1/4 mb-14 md:mb-0 lg:mt-20" }, [
                            createVNode("div", { class: "relative h-full px-6 pt-16 pb-8 text-center bg-gray-100 shadow-sm rounded-7xl shadow-gray-300" }, [
                              ...
                              createVNode("span", { class: "p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50" }, "maria db")
                            ])
                          ])
                        ])
                      ])
                        ...
                        createVNode("div", { class: "flex flex-wrap items-start -mx-4" }, [
                          createVNode("div", { class: "w-full px-4 md:w-1/2 lg:w-1/4 mb-14 lg:mb-0" }, [
                            createVNode("div", { class: "relative h-full px-6 pt-16 pb-8 text-center bg-gray-100 shadow-sm shrink-0 rounded-7xl shadow-gray-300" }, [
                              ...
                              createVNode("span", { class: "p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50" }, "wordpress")
                            ])
                          ]),
                          createVNode("div", { class: "w-full px-4 md:w-1/2 lg:w-1/4 mb-14 lg:mb-0 lg:mt-20" }, [
                            createVNode("div", { class: "relative h-full px-6 pt-16 pb-8 text-center bg-gray-100 shadow-sm rounded-7xl shadow-gray-300" }, [
                              ...
                              createVNode("span", { class: "p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50" }, "canva")
                            ])
                          ]),
                          createVNode("div", { class: "w-full px-4 md:w-1/2 lg:w-1/4 mb-14 lg:mb-0 lg:mt-20" }, [
                            createVNode("div", { class: "relative h-full px-6 pt-16 pb-8 text-center bg-gray-100 shadow-sm shrink-0 rounded-7xl shadow-gray-300" }, [
                              ...
                              createVNode("span", { class: "p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50" }, [
                                ...
                                createVNode("span", { class: "text-[#F34F29]" }, "||"),
                                createTextVNode(" git")
                              ])
                            ])
                          ]),
                          createVNode("div", { class: "w-full px-4 md:w-1/2 lg:w-1/4 mb-14 lg:mb-0" }, [
                            createVNode("div", { class: "relative h-full px-6 pt-16 pb-8 text-center bg-gray-100 shadow-sm shrink-0 rounded-7xl shadow-gray-300" }, [
                              ...
                              createVNode("span", { class: "p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50" }, "digital ocean")
                            ])
                          ])
                        ])
                      ])
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_swiper_slide, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div class="w-full px-1 mb-4 xl:w-auto xl:mb-0"${_scopeId2}><div class="px-6 pt-10 pb-12 mb-10 text-center shadow-sm bg-gray-50 rounded-7xl shadow-gray-300"${_scopeId2}><div class="flex items-center justify-center mb-8 -mt-8"${_scopeId2}><h4 class="text-xl font-medium uppercase font-heading"${_scopeId2}>Project TechnologieS</h4><img${ssrRenderAttr("src", _imports_0$1)} alt=""${_scopeId2}></div><div class="flex flex-col justify-between sm:flex-row lg:mx-14 mx-5"${_scopeId2}><div${_scopeId2}><img class="h-28 w-28 mx-auto mb-5"${ssrRenderAttr("src", _imports_1$1)} alt=""${_scopeId2}></div><div class="flex flex-col"${_scopeId2}><h1 class="flex items-center uppercase"${_scopeId2}><img class="w-6 mr-2"${ssrRenderAttr("src", _imports_2$1)} alt=""${_scopeId2}>html</h1><h1 class="flex items-center uppercase"${_scopeId2}><img class="w-6 mr-2"${ssrRenderAttr("src", _imports_3$1)} alt=""${_scopeId2}>tailwind css</h1><h1 class="flex items-center uppercase"${_scopeId2}><img class="w-6 mr-2"${ssrRenderAttr("src", _imports_4$1)} alt=""${_scopeId2}>java</h1></div><div${_scopeId2}><h1 class="flex items-center uppercase"${_scopeId2}><img class="w-6 mr-2"${ssrRenderAttr("src", _imports_5$1)} alt=""${_scopeId2}>vue js</h1><h1 class="flex items-center uppercase"${_scopeId2}><img class="w-6 mr-2"${ssrRenderAttr("src", _imports_6$1)} alt=""${_scopeId2}>nuxt js</h1></div></div><a target="blank" href="https://bit.ly/3FNc1Cv"${_scopeId2}><span class="p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50"${_scopeId2}>Education website</span></a></div></div>`);
            } else {
              return [
                createVNode("div", { class: "w-full px-1 mb-4 xl:w-auto xl:mb-0" }, [
                  createVNode("div", { class: "px-6 pt-10 pb-12 mb-10 text-center shadow-sm bg-gray-50 rounded-7xl shadow-gray-300" }, [
                    ...
                    createVNode("div", { class: "flex flex-col justify-between sm:flex-row lg:mx-14 mx-5" }, [
                    ...
                    createVNode("a", {
                      ...
                      createVNode("span", { class: "p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50" }, "Education website")
                    ])
                  ])
                ])
              ];
        ...
        _push2(ssrRenderComponent(_component_swiper_slide, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div class="w-full px-1 mb-4 xl:w-auto xl:mb-0"${_scopeId2}><div class="px-6 pt-10 pb-12 mb-10 text-center shadow-sm bg-gray-50 rounded-7xl shadow-gray-300"${_scopeId2}><div class="flex items-center justify-center mb-8 -mt-8"${_scopeId2}><h4 class="text-xl font-medium uppercase font-heading"${_scopeId2}>Project TechnologieS</h4><img${ssrRenderAttr("src", _imports_0$1)} alt=""${_scopeId2}></div><div class="flex flex-col justify-between sm:flex-row lg:mx-14"${_scopeId2}><div${_scopeId2}><img class="h-28 w-28 mx-auto mb-5"${ssrRenderAttr("src", _imports_1$1)} alt=""${_scopeId2}></div><div class="flex flex-col"${_scopeId2}><h1 class="flex items-center uppercase"${_scopeId2}><img class="w-6 mr-2"${ssrRenderAttr("src", _imports_7$1)} alt=""${_scopeId2}>Wordpress</h1><h1 class="flex items-center uppercase"${_scopeId2}><img class="w-6 mr-2"${ssrRenderAttr("src", _imports_8$2)} alt=""${_scopeId2}>Custom CSS</h1></div><div${_scopeId2}><h1 class="flex items-center uppercase"${_scopeId2}><img class="w-6 mr-2"${ssrRenderAttr("src", _imports_9$1)} alt=""${_scopeId2}>Plugins</h1></div></div><a target="blank" href="https://bit.ly/3FMGald"${_scopeId2}><span class="p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50"${_scopeId2}>Wordpress News website</span></a></div></div>`);
            } else {
              return [
                createVNode("div", { class: "w-full px-1 mb-4 xl:w-auto xl:mb-0" }, [
                  createVNode("div", { class: "px-6 pt-10 pb-12 mb-10 text-center shadow-sm bg-gray-50 rounded-7xl shadow-gray-300" }, [
                    ...
                    createVNode("a", {
                      ...
                      createVNode("span", { class: "p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50" }, "Wordpress News website")
                    ])
                  ])
                ])
              ];
        ...
        _push2(ssrRenderComponent(_component_swiper_slide, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div class="w-full px-1 mb-4 xl:w-auto xl:mb-0"${_scopeId2}><div class="px-6 pt-10 pb-12 mb-10 text-center shadow-sm bg-gray-50 rounded-7xl shadow-gray-300"${_scopeId2}><div class="flex items-center justify-center mb-8 -mt-8"${_scopeId2}><h4 class="text-xl font-medium uppercase font-heading"${_scopeId2}>Project TechnologieS</h4><img${ssrRenderAttr("src", _imports_0$1)} alt=""${_scopeId2}></div><div class="flex flex-col justify-between sm:flex-row lg:mx-14"${_scopeId2}><div${_scopeId2}><img class="h-28 w-28 mx-auto mb-5"${ssrRenderAttr("src", _imports_1$1)} alt=""${_scopeId2}></div><div class="flex flex-col"${_scopeId2}><h1 class="flex items-center uppercase"${_scopeId2}><img class="w-6 mr-2"${ssrRenderAttr("src", _imports_2$1)} alt=""${_scopeId2}>html</h1><h1 class="flex items-center uppercase"${_scopeId2}><img class="w-6 mr-2"${ssrRenderAttr("src", _imports_3$1)} alt=""${_scopeId2}>tailwind css</h1></div><div${_scopeId2}><h1 class="flex items-center uppercase"${_scopeId2}><img class="w-6 mr-2"${ssrRenderAttr("src", _imports_10)} alt=""${_scopeId2}>Axios API</h1><h1 class="flex items-center uppercase"${_scopeId2}><img class="w-6 mr-2"${ssrRenderAttr("src", _imports_6$1)} alt=""${_scopeId2}>nuxt js</h1></div></div><a target="blank" href="https://bit.ly/3NjnwUT"${_scopeId2}><span class="p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50"${_scopeId2}>Quotes Website</span></a></div></div>`);
            } else {
              return [
                createVNode("div", { class: "w-full px-1 mb-4 xl:w-auto xl:mb-0" }, [
                  createVNode("div", { class: "px-6 pt-10 pb-12 mb-10 text-center shadow-sm bg-gray-50 rounded-7xl shadow-gray-300" }, [
                    ...
                    createVNode("a", {
                      ...
                      createVNode("span", { class: "p-2 text-sm font-bold text-gray-500 uppercase bg-white rounded-full shadow-inner shadow-blueGray-900/50" }, "Quotes Website")
                    ])
                  ])
                ])
              ];
  ...
  _push(`</div></div><img class="absolute top-0 hidden transform translate-x-1/2 xl:block left-1/2"${ssrRenderAttr("src", _imports_11)} alt=""><div class="w-full px-4 lg:w-1/2"><div class="text-center lg:px-10 md:mb-16"><h2 class="mt-8 font-medium text-9xl md:text-10xl xl:text-11xl font-heading">Details</h2>`);
  _push(ssrRenderComponent(_component_swiper, {
    spaceBetween: 10,
    slidesPerView: 1,
    freeMode: false,
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_swiper_slide, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<img class="block mx-auto mb-12"${ssrRenderAttr("src", _imports_12)} alt=""${_scopeId2}><div class="flex items-start mb-10"${_scopeId2}><img class="rotate-180"${ssrRenderAttr("src", _imports_13)} alt=""${_scopeId2}><div class="max-w-sm mx-auto text-justify -mt-9"${_scopeId2}><h1 class="mx-2 text-2xl font-medium text-blue-500 capitalize"${_scopeId2}>project Ideas :-</h1><p class="mx-2 text-2xl font-medium"${_scopeId2}> I am creating an educational website that is not only easy to use, but also less animated. We believe that this is the first step in empowering people around the world to learn and grow. </p></div><img${ssrRenderAttr("src", _imports_13)} alt=""${_scopeId2}></div>`);
            } else {
              return [
                createVNode("img", {
                ...
                createVNode("div", { class: "flex items-start mb-10" }, [
                  ...
                  createVNode("div", { class: "max-w-sm mx-auto text-justify -mt-9" }, [
                    ...
                    createVNode("p", { class: "mx-2 text-2xl font-medium" }, " I am creating an educational website that is not only easy to use, but also less animated. We believe that this is the first step in empowering people around the world to learn and grow. ")
                  ]),
                  createVNode("img", {
                    src: _imports_13,
                    alt: ""
        ...
        _push2(ssrRenderComponent(_component_swiper_slide, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<img class="block mx-auto mb-12"${ssrRenderAttr("src", _imports_12)} alt=""${_scopeId2}><div class="flex items-start mb-10"${_scopeId2}><img class="rotate-180"${ssrRenderAttr("src", _imports_13)} alt=""${_scopeId2}><div class="max-w-sm mx-auto text-justify -mt-9"${_scopeId2}><h1 class="mx-2 text-2xl font-medium text-blue-500 capitalize"${_scopeId2}>project Ideas :-</h1><p class="mx-2 text-2xl font-medium"${_scopeId2}>A news website with a creative and unique design. We are also fast and optimized for top performance on the search engine result pages.</p></div><img${ssrRenderAttr("src", _imports_13)} alt=""${_scopeId2}></div>`);
            } else {
              return [
                createVNode("img", {
                  class: "block mx-auto mb-12",
                ...
                createVNode("div", { class: "flex items-start mb-10" }, [
                  ...
                  createVNode("div", { class: "max-w-sm mx-auto text-justify -mt-9" }, [
                    createVNode("h1", { class: "mx-2 text-2xl font-medium text-blue-500 capitalize" }, "project Ideas :-"),
                    createVNode("p", { class: "mx-2 text-2xl font-medium" }, "A news website with a creative and unique design. We are also fast and optimized for top performance on the search engine result pages.")
                  ]),
                  createVNode("img", {
                    src: _imports_13,
                    alt: ""
        ...
        _push2(ssrRenderComponent(_component_swiper_slide, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<img class="block mx-auto mb-12"${ssrRenderAttr("src", _imports_12)} alt=""${_scopeId2}><div class="flex items-start mb-10"${_scopeId2}><img class="rotate-180"${ssrRenderAttr("src", _imports_13)} alt=""${_scopeId2}><div class="max-w-sm mx-auto text-justify -mt-9"${_scopeId2}><h1 class="mx-2 text-2xl font-medium text-blue-500 capitalize"${_scopeId2}>project Ideas :-</h1><p class="mx-2 text-2xl font-medium"${_scopeId2}>Some quotes are very nice. I have created a quotes website with public available API and axios package.</p></div><img${ssrRenderAttr("src", _imports_13)} alt=""${_scopeId2}></div>`);
            } else {
              return [
                createVNode("img", {
                  class: "block mx-auto mb-12",
                ...
                createVNode("div", { class: "flex items-start mb-10" }, [
                  ...
                  createVNode("div", { class: "max-w-sm mx-auto text-justify -mt-9" }, [
                    createVNode("h1", { class: "mx-2 text-2xl font-medium text-blue-500 capitalize" }, "project Ideas :-"),
                    createVNode("p", { class: "mx-2 text-2xl font-medium" }, "Some quotes are very nice. I have created a quotes website with public available API and axios package.")
                  ]),
                  createVNode("img", {
                    src: _imports_13,
                    alt: ""
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Switch), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="sr-only text-red-500"${_scopeId}>Use setting</span><span aria-hidden="true" class="${ssrRenderClass([enabled.value ? "translate-x-9" : "translate-x-0", "pointer-events-none inline-block h-[20px] w-[20px] rounded-full bg-white shadow-lg transform ring-0 transition ease-in-out duration-200"])}"${_scopeId}></span>`);
          } else {
            return [
              createVNode("span", { class: "sr-only text-red-500" }, "Use setting"),
              createVNode("span", {
                "aria-hidden": "true",
