...
__vite_ssr_exports__.default = /*#__PURE__*/__vite_ssr_import_6__.default(_sfc_main, [['ssrRender',_sfc_ssrRender],['__file',"C:/Users/acer/Downloads/temp/nuxt3-tailwind3-starter-main/nuxt3-tailwind3-starter-main/pages/index.vue"]]);
}
          ...
          default: __vite_ssr_import_8__.withCtx((_, _push, _parent, _scopeId) => {
            if (_push) {
              _push(`<div class="w-full px-1 mb-4 xl:w-auto xl:mb-0"${
                ...
                _scopeId
              }><img class="w-6 mr-2" src="/_nuxt/assets/images/mycollection/html-5.svg" alt=""${
                _scopeId
              }>html</h1><h1 class="flex items-center uppercase"${
                _scopeId
              }><img class="w-6 mr-2" src="/_nuxt/assets/images/mycollection/tailwindcss.svg" alt=""${
                _scopeId
              }>tailwind css</h1><h1 class="flex items-center uppercase"${
                _scopeId
              }><img class="w-6 mr-2" src="/_nuxt/assets/images/mycollection/javascript.svg" alt=""${
                _scopeId
              }>java</h1></div><div${
                _scopeId
              }><h1 class="flex items-center uppercase"${
                _scopeId
              }><img class="w-6 mr-2" src="/_nuxt/assets/images/mycollection/vue.svg" alt=""${
                _scopeId
              }>vue js</h1><h1 class="flex items-center uppercase"${
                _scopeId
              }><img class="w-6 mr-2" src="/_nuxt/assets/images/mycollection/nuxt.svg" alt=""${
                _scopeId
                    ...
                    __vite_ssr_import_8__.createVNode("div", { class: "flex flex-col sm:flex-row justify-between lg:mx-14" }, [
                      ...
                      __vite_ssr_import_8__.createVNode("div", { class: "flex flex-col" }, [
                        __vite_ssr_import_8__.createVNode("h1", { class: "flex items-center uppercase" }, [
                          __vite_ssr_import_8__.createVNode("img", {
                            class: "w-6 mr-2",
                            src: "/_nuxt/assets/images/mycollection/html-5.svg",
                            alt: ""
                          }),
                        ...
                        __vite_ssr_import_8__.createVNode("h1", { class: "flex items-center uppercase" }, [
                          __vite_ssr_import_8__.createVNode("img", {
                            class: "w-6 mr-2",
                            src: "/_nuxt/assets/images/mycollection/tailwindcss.svg",
                            alt: ""
                          }),
                        ...
                        __vite_ssr_import_8__.createVNode("h1", { class: "flex items-center uppercase" }, [
                          __vite_ssr_import_8__.createVNode("img", {
                            class: "w-6 mr-2",
                            src: "/_nuxt/assets/images/mycollection/javascript.svg",
                            alt: ""
                          }),
                      ...
                      __vite_ssr_import_8__.createVNode("div", null, [
                        __vite_ssr_import_8__.createVNode("h1", { class: "flex items-center uppercase" }, [
                          __vite_ssr_import_8__.createVNode("img", {
                            class: "w-6 mr-2",
                            src: "/_nuxt/assets/images/mycollection/vue.svg",
                            alt: ""
                          }),
                        ...
                        __vite_ssr_import_8__.createVNode("h1", { class: "flex items-center uppercase" }, [
                          __vite_ssr_import_8__.createVNode("img", {
                            class: "w-6 mr-2",
                            src: "/_nuxt/assets/images/mycollection/nuxt.svg",
                            alt: ""
                          }),
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${__vite_ssr_import_0__.ssrRenderAttrs(_attrs)}><section id="home" class="py-16 overflow-hidden 2xl:py-20"><div class="relative bg-gray-100 shadow-2xl shadow-gray-900 rounded-b-10xl"><div class="container px-4 mx-auto"><div class="flex flex-wrap items-center py-10 -mx-4"><div class="w-full px-4 mb-24 lg:w-1/2 lg:mb-0"><h1 class="max-w-xl mb-16 font-medium leading-none font-heading text-9xl md:text-10xl xl:text-11xl"><span>Hi, it&#39;s me <span class="underline text-blueGray-700">G</span>anpat <span class="underline text-blueGray-700">J</span>angra and I am a </span><span class="relative inline-block"><span class="absolute inset-0 xl:-left-8 xl:-right-8"><img class="absolute inset-0 w-full max-w-non" src="/_nuxt/assets/images/mycollection/lines-blue1.svg" alt=""><img class="absolute inset-0 w-full mt-1 lg:mt-2 xl:ml-4 max-w-none" src="/_nuxt/assets/images/mycollection/lines-blue2.svg" alt=""></span><!-- full stack --><span class="relative z-10"> web dev.</span></span></h1><div class="space-y-2"><h1 class="text-xl capitalize">previous study</h1><p class="text-lg leading-snug lg:mb-24 text-darkBlueGray-400">In 2020, I complete my engineering.</p><h1 class="text-xl capitalize">currently study</h1><p class="text-lg leading-snug lg:mb-24 text-darkBlueGray-400"> leaning MEVN and communication skills in English language. </p><h1 class="text-xl capitalize">future study</h1><p class="text-lg leading-snug lg:mb-24 text-darkBlueGray-400">BCA in Australia.</p></div></div><div class="w-full px-4 lg:w-1/2"><div class="relative mx-auto"><div class="w-64 h-64 mx-auto border-4 border-gray-700 rounded-full"><!-- profile image second circule  --><div class="w-56 h-56 mx-auto border-4 border-gray-400 rounded-full"><!-- profile image third circule  --><div class="relative flex items-center justify-center w-48 h-48 mx-auto border-4 rounded-full"><img class="w-36 -mt-9" src="/_nuxt/assets/images/mycollection/myAvatar.svg" alt=""></div></div></div></div></div></div><div class="mb-5"><h1 class="capitalize text-6xl font-semibold mb-5">Contact</h1><div class="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 place-items-center"><div class="flex items-center w-full mb-6 xl:w-1/2"><img class="mr-6 h-14" src="/_nuxt/assets/images/mycollection/github-icon.svg" alt=""><a class="text-3xl font-medium hover:text-blueGray-500" target="blankpage" href="https://github.com/GanpatJangra">Github <h1 class="text-sm">@ganpatjangra</h1></a></div><div class="flex items-center w-full mb-6 xl:w-1/2"><img class="mr-6 h-14" src="/_nuxt/assets/images/mycollection/linkedin-tile.svg" alt=""><a class="text-3xl font-medium hover:text-blueGray-500" target="blankpage" href="https://www.linkedin.com/in/ganpat-jangra-4b3a9621a/">Linkdin <h1 class="text-sm">@ganpatjangra</h1></a></div><div class="flex items-center w-full mb-6 xl:w-1/2"><img class="mr-6 h-14" src="/_nuxt/assets/images/mycollection/gmail-icon.svg" alt=""><a class="text-3xl font-medium hover:text-blueGray-500" target="blankpage" href="#">Mail <h1 class="text-sm">ganpatjangra@gmail.com</h1></a></div><div class="flex items-center w-full mb-6 xl:w-1/2"><img class="mr-6 h-14" src="/_nuxt/assets/images/mycollection/icon1.svg" alt=""><a class="text-3xl font-medium hover:text-blueGray-500" target="blankpage" href="#">Call <h1 class="text-sm">+91 8708423836</h1></a></div></div></div></div></div></section></div>`)
}
...
__vite_ssr_exports__.default = /*#__PURE__*/__vite_ssr_import_2__.default(_sfc_main, [['ssrRender',_sfc_ssrRender],['__file',"C:/Users/acer/Downloads/temp/nuxt3-tailwind3-starter-main/nuxt3-tailwind3-starter-main/components/home.vue"]]);
}
